...
// Manage Class screen before its roster was built out.
    ...
    <>
      ...
      <main className="min-h-screen px-lg pb-2xl pt-[104px] lg:px-2xl">
        <div className="mx-auto max-w-5xl">
          ...
          <h1 className="mt-lg text-2xl font-semibold text-ink-primary">Manage Class</h1>
          <p className="mt-xs text-sm text-ink-muted">Class management tools coming soon.</p>
        </div>
      </main>
    </>
  );
